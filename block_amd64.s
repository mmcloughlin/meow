...
finish:
	...
	// Rotation block 0.
	VAESDEC  272(SP), X0, X0
	VAESDEC  288(SP), X1, X1
	VAESDEC  304(SP), X2, X2
	...
	// Rotation block 1.
	VAESDEC  288(SP), X0, X0
	VAESDEC  304(SP), X1, X1
	VAESDEC  320(SP), X2, X2
	VAESDEC  272(SP), X3, X3
	VAESDEC  X5, X0, X0
	VAESDEC  X6, X1, X1
	VAESDEC  X7, X2, X2
	VAESDEC  X4, X3, X3
	...
	// Rotation block 2.
	VAESDEC  304(SP), X0, X0
	VAESDEC  320(SP), X1, X1
	VAESDEC  272(SP), X2, X2
	VAESDEC  288(SP), X3, X3
	VAESDEC  X6, X0, X0
	VAESDEC  X7, X1, X1
	VAESDEC  X4, X2, X2
	VAESDEC  X5, X3, X3
	...
	VAESDEC  272(SP), X1, X1
	VAESDEC  288(SP), X2, X2
	VAESDEC  304(SP), X3, X3
	VAESDEC  X7, X0, X0
	VAESDEC  X4, X1, X1
	VAESDEC  X5, X2, X2
	VAESDEC  X6, X3, X3
